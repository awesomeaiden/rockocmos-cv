...
imgTrainingNumbers = cv2.imread("ocr_samples/othertext4.png")            # read in training numbers image
...
for npaContour in npaContours:                          # for each contour
    if cv2.contourArea(npaContour) > MIN_CONTOUR_AREA:          # if contour is big enough to consider
        ...
        # Draw blue rectangle around the previous feature
        cv2.rectangle(imgTrainingNumbers, (lastX, lastY), (lastX + lastW, lastY + lastH), (255, 0, 0), 2)
